...
?>
	...
	<footer class="site-footer footer" role="contentinfo">
		<div class="footer-row u-container">
                       
            <div class="masthead footer-column">
                <a href="<?php echo get_home_url(); ?>" class="hsc-logo">
                    <span class="u-display-none">Hester Street Collaborative</span>
                </a>
            </div>
